    ...
    <div className="container">
      <div className="row">
        <div className="col">
          ...
          <p>
            This dataset provides a comprehensive analysis of mobile device
            usage patterns and user behavior classification. It contains 700
            samples of user data, including metrics such as app usage time,
            screen-on time, battery drain, and data consumption. Each entry is
            categorized into one of five user behavior classes, ranging from
            light to extreme usage, allowing for insightful analysis and
            modeling.
          </p>
          <h1>Key Features:</h1>
          <ul>
            ...
            <li>
              App Usage Time: Daily time spent on mobile applications, measured
              in minutes.
            </li>
            ...
            <li>
              User Behavior Class: Classification of user behavior based on
              usage patterns (1 to 5).
            </li>
          </ul>
          <p>
